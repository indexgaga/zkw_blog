...
<script src="<%=request.getContextPath()%>/back/js/bootstrap.min.js"></script>
<script src="<%=request.getContextPath()%>/back/js/admin-scripts.js"></script>
<script src="<%=request.getContextPath()%>/back/lib/ueditor/ueditor.config.js"></script>
<script src="<%=request.getContextPath()%>/back/lib/ueditor/ueditor.all.min.js"> </script>
<script src="<%=request.getContextPath()%>/back/lib/ueditor/lang/zh-cn/zh-cn.js"></script>
