...
<section class="container container-page">
  <div class="pageside">
    <div class="pagemenus">
      <ul class="pagemenu">
        <li><a href="tags.jsp">标签云</a></li>
        <li><a href="readers.jsp">读者墙</a></li>
        <li><a href="links.jsp">友情链接</a></li>
      </ul>
    </div>
  </div>
  <div class="content">
    ...
    <div class="readers"> <a class="item-readers item-readers-1" target="_blank" href="" rel="nofollow">
      ...
      <img class="avatar" height="36" width="36" src="images/icon/icon.png" alt=""><strong>异清轩</strong>http://www.ylsat.com/</a> <a class="item-readers item-readers-2" target="_blank" href="" rel="nofollow">
      <h4>【银牌读者】<small>评论：12</small></h4>
      <img class="avatar" height="36" width="36" src="images/icon/icon.png" alt=""><strong>异清轩</strong>http://www.ylsat.com/</a> <a class="item-readers item-readers-3" target="_blank" href="" rel="nofollow">
      <h4>【铜牌读者】<small>评论：8</small></h4>
      <img class="avatar" height="36" width="36" src="images/icon/icon.png" alt=""><strong>异清轩</strong>http://www.ylsat.com/</a> <a class="item-readers item-readers-4" target="_blank" href="" rel="nofollow">
      <h4>【普通读者】<small>评论：1</small></h4>
      <img class="avatar" height="36" width="36" src="images/icon/icon.png" alt=""><strong>异清轩</strong>http://www.ylsat.com/</a> </div>
  </div>
</section>
<footer class="footer">
  <div class="container">
